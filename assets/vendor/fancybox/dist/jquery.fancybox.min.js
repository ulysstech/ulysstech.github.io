    ...
    if (n) {
        ...
        var a = {
            ...
            h = function(t, o, i) {
                ...
                s.opts = n.extend(!0, {
                    index: i
                }, a, o || {}), n.fancybox.isMobile && (s.opts = n.extend(!0, {}, s.opts, s.opts.mobile)), o && n.isArray(o.buttons) && (s.opts.buttons = o.buttons), s.id = s.opts.id || ++c, s.group = [], s.currIndex = parseInt(s.opts.index, 10) || 0, s.prevIndex = null, s.prevPos = null, s.currPos = 0, s.firstRun = null, s.createGroup(t), s.group.length && (s.$lastFocus = n(e.activeElement).blur(), s.slides = {}, s.init(t))
            };
        n.extend(h.prototype, {
            init: function() {
                ...
                c.scrollTop = r.scrollTop(), c.scrollLeft = r.scrollLeft(), n.fancybox.getInstance() || (n("body").addClass("fancybox-active"), /iPad|iPhone|iPod/.test(navigator.userAgent) && !t.MSStream ? "image" !== l.type && n("body").css("top", n("body").scrollTop() * -1).addClass("fancybox-iosfix") : !n.fancybox.isMobile && e.body.scrollHeight > t.innerHeight && (d === o && (i = n('<div style="width:50px;height:50px;overflow:scroll;" />').appendTo("body"), d = n.fancybox.scrollbarWidth = i[0].offsetWidth - i[0].clientWidth, i.remove()), n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar { margin-right: ' + d + "px; }</style>"), n("body").addClass("compensate-for-scrollbar"))), s = "", n.each(u.buttons, function(t, e) {
                    s += u.btnTpl[e] || ""
                }), a = n(c.translate(c, u.baseTpl.replace("{{buttons}}", s).replace("{{arrows}}", u.btnTpl.arrowLeft + u.btnTpl.arrowRight))).attr("id", "fancybox-container-" + c.id).addClass("fancybox-is-hidden").addClass(u.baseClass).data("FancyBox", c).prependTo(u.parentEl), c.$refs = {
                    container: a
            ...
            createGroup: function(t) {
                ...
                n.each(i, function(t, i) {
                    var a, s, r, c, l = {},
                        u = {};
                    n.isPlainObject(i) ? (l = i, u = i.opts || i) : "object" === n.type(i) && n(i).length ? (a = n(i), u = a.data(), u = n.extend({}, u, u.options || {}), u.$orig = a, l.src = u.src || a.attr("href"), l.type || l.src || (l.type = "inline", l.src = i)) : l = {
                        type: "html",
                        src: i + ""
            ...
            updateControls: function(t) {
                var e = this,
                    ...
                    a = o.opts.caption,
                    s = e.$refs.caption;
                o.$slide.trigger("refresh"), e.$caption = a && a.length ? s.html(a) : null, e.isHiddenControls || e.isIdle || e.showControls(), n("[data-fancybox-count]").html(e.group.length), n("[data-fancybox-index]").html(i + 1), n("[data-fancybox-prev]").prop("disabled", !o.opts.loop && i <= 0), n("[data-fancybox-next]").prop("disabled", !o.opts.loop && i >= e.group.length - 1), "image" === o.type ? n("[data-fancybox-download]").attr("href", o.opts.image.src || o.src) : n("[data-fancybox-download]").hide()
            },
...
function(t) {
    ...
    t(document).on("onInit.fb", function(o, i) {
        t.each(i.group, function(o, i) {
            ...
            }), i.contentProvider = d, i.opts.slideClass += " fancybox-slide--" + ("gmap_place" == d || "gmap_search" == d ? "map" : "video"))) : f && (i.type = "image"))
        })
    })
...
function(t, e, n) {
    ...
    u.prototype.destroy = function() {
        ...
        if ((!o.originalEvent || 2 != o.originalEvent.button) && c.length && !r(c) && !r(c.parent()) && !(o.originalEvent.clientX > c[0].clientWidth + c.offset().left) && (i.startPoints = a(o), i.startPoints && !(i.startPoints.length > 1 && u.isSliding))) {
            if (i.$target = c, i.$content = f, i.canTap = !0, i.opts = d.opts.touch, n(e).off(".fb.touch"), n(e).on(h ? "touchend.fb.touch touchcancel.fb.touch" : "mouseup.fb.touch mouseleave.fb.touch", n.proxy(i, "ontouchend")), n(e).on(h ? "touchmove.fb.touch" : "mousemove.fb.touch", n.proxy(i, "ontouchmove")), !i.opts && !u.canPan() || !c.is(i.$stage) && !i.$stage.find(c).length) return void(c.is("img") && o.preventDefault());
...
function(t, e) {
    ...
    e.extend(!0, e.fancybox.defaults, {
        ...
        t && e.fancybox.open({
            src: t.translate(t, t.current.opts.share.tpl.replace(/\{\{src\}\}/g, encodeURI(t.current.src)).replace(/\{\{descr\}\}/g, encodeURI(t.current.opts.caption || ""))),
            type: "html",
            opts: {
                autoFocus: !1,
